...
//this function give the amount either in inr or in usd
...
//compute Totals for subtotal, tax and total
  ...
  async function handleSave() {
    ...
    try {
      ...
      const prepared = {
        ...
        notes: invoice.notes || "",
        localId: invoice.id,
      };  //things that will save in backend
      ...
      const endpoint =
        isEditing && invoice.id
          ...
          : `${API_BASE}/api/invoice`; //its a post route to create the invoice in the mongoDB
