...
// file handling helpers: kind = "logo" | "stamp" | "signature"
  ...
  //you can remove the preview file by this function if you want to change
  ...
  //save business profile in the DB
            ...
            <div className={businessProfileStyles.cardContainer}>
                ...
                <div className={businessProfileStyles.gridColSpan2}>
                    <div>
                        ...
                        <input className={businessProfileStyles.input} value={meta.businessName || ""} 
