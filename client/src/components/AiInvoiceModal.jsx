        ...
        <div className={aiInvoiceModalStyles.modal}>
            ...
            <div className="mt-4">
                ...
                <textarea value={text} onChange={(e) => setText(e.target.value)}
                    placeholder={`eg. A person wants a logo design for her organic brand "GreenVibe." Quoted for $120 for 2 logo
                    options and final delivery in PNG and Vector format`} rows={8} className={aiInvoiceModalStyles.textarea}>
                </textarea>
            </div>
            {error && (
