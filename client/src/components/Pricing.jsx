    ...
    style={{ transition: `${delay}ms` }}>
        ...
        <div className={pricingCardStyles.content}>
            <div className={pricingCardStyles.header}>
                ...
                <p className={pricingCardStyles.description}>
                    {description}
                </p>
            </div>
            <div className={pricingCardStyles.priceContainer}>
                <div className={pricingCardStyles.priceWrapper}>
                    ...
                    {period && (
                        <span className={pricingCardStyles.period}>
                            /{period}
                        </span>
                    )}
                </div>
                {isAnnual && (
                    <div className={pricingCardStyles.annualBadge}>Save 20% annualy</div>
                )}
            </div>
        ...
        <div className={pricingStyles.container}>
            ...
            <div className={pricingStyles.grid}>
                {currentPlans.map((plan, index) => (
                    <PricingCard key={plan.tile} {...plan} delay={index * 100} onCtaClick={handleCtaClick} />
                ))}
            </div>
